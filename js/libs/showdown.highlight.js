(function (root, factory) {
    if ((typeof (define) === "function") && define.amd) {
        ...
        define(["showdown", "highlight", "highlightLineNnumbers"], factory);
    } 
    else {
        // Browser globals
        return factory(root.showdown, root.hljs);
    }
}((typeof (self) !== "undefined") ? self : this, function (showdown, highlight) {
   //#region [ Fields ]
    ...
    */
    ...
    var Extension = {
        ...
        filter: function(text, converter, options) {
            var highlightAuto = (typeof(options.highlightAuto) === "boolean") ? options.highlightAuto : true;
            var left  = "<pre><code\\b[^>]*>";
            var right = "</code></pre>";
            var flags = "g";
